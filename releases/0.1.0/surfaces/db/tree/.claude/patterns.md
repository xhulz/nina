...
- **NEVER cache reads that feed a conciliation or payout write** — a stale `{{ENTRY_MODEL}}` or `{{ACCOUNT_MODEL}}.balance` contaminates real money movement. Hard reject in dba review.
