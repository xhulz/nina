...
- Node.js with zero runtime dependencies. About 8.9k lines of source and 3.8k lines of tests.
- 39 frozen releases so far. The package ships all of them, so an upgrade can compose its target and report the
