...
- Reviewer verifies: typecheck clean, Biome clean, dba approved (if the database was touched), integration-tester approved (if an integration boundary was touched), no secret leaked, no PII in logs or tests.
