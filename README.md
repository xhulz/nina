...
- Node.js with zero runtime dependencies. About 9.5k lines of source and 4k lines of tests.
- 41 frozen releases so far. The package ships all of them, so an upgrade can compose its target and report the
