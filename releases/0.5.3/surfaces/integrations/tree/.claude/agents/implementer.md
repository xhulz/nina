...
## Integrations
- All access to a dependency goes through its **boundary module**, named in `.harness/profile.json`. **Never** reach it directly from a service, route, queue consumer or scheduled handler.
